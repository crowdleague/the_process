...
@freezed
class SignInWithGoogle with _$SignInWithGoogle {
  factory SignInWithGoogle() = _SignInWithGoogle;

  factory SignInWithGoogle.fromJson(Map<String, dynamic> json) =>
      _$SignInWithGoogleFromJson(json);
}
