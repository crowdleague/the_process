...
part 'store_auth_user_data.freezed.dart';
part 'store_auth_user_data.g.dart';

@freezed
class StoreAuthUserData with _$StoreAuthUserData {
  factory StoreAuthUserData({AuthUserData? authUserData}) = _StoreAuthUserData;

  factory StoreAuthUserData.fromJson(Map<String, dynamic> json) =>
      _$StoreAuthUserDataFromJson(json);
}
