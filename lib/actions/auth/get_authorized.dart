...
part 'get_authorized.freezed.dart';
part 'get_authorized.g.dart';

@freezed
class GetAuthorized with _$GetAuthorized {
  factory GetAuthorized({required ProviderName provider}) = _GetAuthorized;

  factory GetAuthorized.fromJson(Map<String, dynamic> json) =>
      _$GetAuthorizedFromJson(json);
}
