...
part 'observe_auth_state.freezed.dart';
part 'observe_auth_state.g.dart';

@freezed
class ObserveAuthState with _$ObserveAuthState {
  factory ObserveAuthState() = _ObserveAuthState;

  factory ObserveAuthState.fromJson(Map<String, dynamic> json) =>
      _$ObserveAuthStateFromJson(json);
}
