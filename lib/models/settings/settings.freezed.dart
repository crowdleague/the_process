...
class _$SettingsCopyWithImpl<$Res> implements $SettingsCopyWith<$Res> {
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      darkTheme:
          darkTheme == freezed ? _value.darkTheme : darkTheme as ThemeSet,
      lightTheme:
          lightTheme == freezed ? _value.lightTheme : lightTheme as ThemeSet,
      brightnessMode: brightnessMode == freezed
          ? _value.brightnessMode
          : brightnessMode as BrightnessMode,
      platform:
          platform == freezed ? _value.platform : platform as PlatformEnum,
    ));
  }
