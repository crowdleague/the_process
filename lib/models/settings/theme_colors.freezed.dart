...
class _$ThemeColorsCopyWithImpl<$Res> implements $ThemeColorsCopyWith<$Res> {
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      primary: primary == freezed ? _value.primary : primary as int,
      secondary: secondary == freezed ? _value.secondary : secondary as int,
...
class _$_ThemeColors implements _ThemeColors {
  ...
  Map<String, dynamic> toJson() {
    return _$_$_ThemeColorsToJson(this);
  }
}
