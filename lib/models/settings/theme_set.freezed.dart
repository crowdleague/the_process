...
class _$ThemeSetTearOff {
  ...
  _ThemeSet call(
      {required ThemeColors colors, required ThemeBrightness brightness}) {
    return _ThemeSet(
      colors: colors,
...
mixin _$ThemeSet {
  ...
  ThemeBrightness get brightness => throw _privateConstructorUsedError;
...
abstract class $ThemeSetCopyWith<$Res> {
  ...
  $Res call({ThemeColors colors, ThemeBrightness brightness});
...
class _$ThemeSetCopyWithImpl<$Res> implements $ThemeSetCopyWith<$Res> {
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      colors: colors == freezed ? _value.colors : colors as ThemeColors,
...
class _$_ThemeSet implements _ThemeSet {
  ...
  Map<String, dynamic> toJson() {
    return _$_$_ThemeSetToJson(this);
  }
}
...
abstract class _ThemeSet implements ThemeSet {
  factory _ThemeSet(
      ...
      required ThemeBrightness brightness}) = _$_ThemeSet;
